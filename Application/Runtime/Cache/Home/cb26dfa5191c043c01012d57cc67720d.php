    ...
    <div class="tb">
            <table border="1"  style="border-collapse:collapse;">
                ...
                <tr>
                    <td>试驾方式：</td>
                    <td>
                        <?php if($info["shijia"] == 1): ?>上门试驾
                        <?php else: ?> 到店试驾<?php endif; ?></td>
                </tr>
                <tr>
                    <td>地址：</td>
                    <td><?php echo ($info["ad"]); ?></td>
                </tr>
                <tr>
                    <td>备注：</td>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <?php if($info["zhuangtai"] == 4): ?><p>订单已经取消</p>
                            ...
                            <p>订单已经消费</p>
                            <?php else: ?>
                            <input type="button" value="取消预约" onclick="location.href='qx2?yid=<?php echo ($info["yid"]); ?>'" class="tj"><?php endif; ?>
