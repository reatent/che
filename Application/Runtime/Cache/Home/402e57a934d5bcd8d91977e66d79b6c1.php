...
<?php if(is_array($orderinfo)): $i = 0; $__LIST__ = $orderinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li id="<?php echo (strtolower($vo['firstword'])); ?>"><?php echo ($vo['firstword']); ?> </li>
	<?php if(is_array($vo['voo'])): $i = 0; $__LIST__ = $vo['voo'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2o): $mod = ($i % 2 );++$i;?><div class="li1"onclick="location.href='asdmd4?id=<?php echo ($v2o["id"]); ?>'">
			<div class="lg1">
