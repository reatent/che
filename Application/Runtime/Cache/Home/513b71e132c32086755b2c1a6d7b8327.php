...
<div class="main">
    <div class="tb">
        <form id="yy2" method="post" action="/web/haval/index.php/Home/Index/addyuyue3">
            <table>
                <tr>
                ...
                <tr>
                    <td>车牌号</td>
                    <td><input type="text" id="ad" name="cph" class="txt"></td>
                </tr>
                <tr>
                    <td>备注：</td>
                ...
                <tr>
                    <td>故障描述：</td>
                    <td><textarea type="text" rows="5" id="gzms" name="gzms" class="txt1"></textarea></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
