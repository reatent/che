...
//                    document.getElementById('times').innerHTML= xhr.responseText;
                }}
            //创建HTTP请求
...
<div class="name"><?php echo ($infos['carname']); ?>-<?php echo ($infos['modelname']); ?> -<?php echo ($infos['displacementname']); ?></div>
<div class="main">
    <div class="tb">
        <form id="yy2" method="post" action="/web/haval/index.php/Home/Index/yzcode">
            <table>
                <input type="hidden" name="id"  value="<?php echo ($rands); ?>"/>
                <input type="hidden" name="rand" id="id" value="<?php echo ($rand); ?>"/>
                <tr>
                    <td>手机验证码</td>
