        ...
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <?php echo ($infos["displacementname"]); ?>的零件列表
                </div>
                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-title">零件名称</th>
                                    <th class="table-title">零件种类名称</th>
                                    <th class="table-title">零件价格</th>
                                ...
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($i); ?></td>
                                        <td><a href="#"><?php echo ($vo["dcname"]); ?></a></td>
                                        <td><a href="#"><?php echo ($vo["componentname"]); ?></a></td>
                                        <td><a href="#"><?php echo ($vo["dcprice"]); ?></a></td>
                                        <td>
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <a href="/web/haval/index.php/Admin/Index/componentsave?id=<?php echo ($vo["dcid"]); ?>"
                                                       class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">

                                                  <span class="am-icon-pencil-square-o"></span>修改零件信息

                                                    </a>
                                                    <a href="/web/haval/index.php/Admin/Index/deldc?id=<?php echo ($vo["dcid"]); ?>"
                                                       class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">

                                                        <span class="am-icon-copy"></span>删除零件
