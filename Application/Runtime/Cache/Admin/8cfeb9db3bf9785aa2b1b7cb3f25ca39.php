            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <!-- <span class="am-icon-code"></span> -->修改车型
                    </div>
                </div>
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" method="post" action="/web/haval/index.php/Admin/Index/modelsave">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">车型名称</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="modelname" id="user-name" value="<?php echo ($info["modelname"]); ?>">
