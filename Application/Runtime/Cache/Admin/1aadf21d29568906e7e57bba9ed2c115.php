                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($i); ?></td>
                                        <td><a href="#"><?php echo ($vo["modelname"]); ?></a></td>
                                        <td>
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <a href="/web/haval/index.php/Admin/Index/displacementlist?id=<?php echo ($vo["mid"]); ?>"
                                                       class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">

                                                        <span class="am-icon-copy"></span>查看排量-年款

                                                    </a>
                                                    <a href="/web/haval/index.php/Admin/Index/displacement?id=<?php echo ($vo["mid"]); ?>"
                                                       class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">

                                                        <span class="am-icon-copy"></span>增加排量-年款

                                                    </a>
                                                    <a href="/web/haval/index.php/Admin/Index/savemodel?id=<?php echo ($vo["mid"]); ?>"
                                                       class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">

                                                        <span class="am-icon-pencil-square-o"></span>修改车型

                                                    </a>
                                                    <a href="/web/haval/index.php/Admin/Index/delmodel?id=<?php echo ($vo["mid"]); ?>"
                                                       class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">

                                                        <span class="am-icon-trash-o"></span> 删除车型
