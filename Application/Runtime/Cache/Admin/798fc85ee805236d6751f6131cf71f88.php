                                        ...
                                        <td>
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <a href="/web/haval/index.php/Admin/Index/savedisplacement?id=<?php echo ($vo["did"]); ?>"
                                                       class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">

                                                  <span class="am-icon-pencil-square-o"></span>修改排量-年款

                                                    </a>
                                                    <a href="/web/haval/index.php/Admin/Index/deldisplacement?id=<?php echo ($vo["did"]); ?>"
                                                       class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">

                                                        <span class="am-icon-trash-o"></span> 删除排量-年款
