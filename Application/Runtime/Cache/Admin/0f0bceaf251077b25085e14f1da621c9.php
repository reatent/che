                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><a href="#"><?php if($vo["bytype"] == 1): ?>到店汽车保养<?php else: ?>上门汽车保养<?php endif; ?></a></td>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <?php if(is_array($vo['voo'])): $i = 0; $__LIST__ = $vo['voo'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2o): $mod = ($i % 2 );++$i; echo ($v2o["dcname"]); ?>.........<?php echo ($v2o["dcprice"]); ?>元<br><?php endforeach; endif; else: echo "" ;endif; ?>
                                                            地址：<?php echo ($vo["ad"]); ?><br>
                                                            备注：<?php echo ($vo["bz"]); ?>
                                                        </div>
