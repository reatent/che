            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
                        <form class="am-form am-form-horizontal" method="post" action="/web/haval/index.php/Admin/Index/dcadd">
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">零件种类</label>

                                <div class="am-u-sm-9">
                                    <select name="cid" id="" class="am-u-sm-3 am-form-label" >
                                        <option value="0">请选择</option>
                                        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cid"]); ?>"><?php echo ($vo["componentname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                <label for="user-name"  class="am-u-sm-3 am-form-label">零件名称</label>

                                <div class="am-u-sm-9">
                                    <input type="text"  name="dcname" id="user-name" placeholder="零件名称">
                                </div>
                            </div>

                            <div class="am-form-group">
                                <label for="user-price"  class="am-u-sm-3 am-form-label">零件价格</label>

                                <div class="am-u-sm-9">
                                    <input type="text" name="dcprice" id="user-price" placeholder="零件价格">
                                </div>
                            </div>

                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    <input type="submit" class="am-btn am-btn-primary" value="增加零件" />
                                </div>
                            </div>
                        </form>
                    </div>
