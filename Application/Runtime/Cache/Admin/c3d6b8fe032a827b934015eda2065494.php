                    ...
                    <div class="am-u-sm-12">
                            ...
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($i); ?></td>
                                        <td><a href="#"><?php echo ($vo["username"]); ?></a></td> <form method="post" action="/web/haval/index.php/Admin/Index/addadmin">
                                        <td>

                                            <input type="hidden" value="<?php echo ($vo["uid"]); ?>" name="uid">
                                            试驾管理员<input type="checkbox" value="1" name="sjadmin" <?php if($vo["role1"] == 1): ?>checked<?php endif; ?>>
                                            保养管理员<input type="checkbox" value="1" name="byadmin" <?php if($vo["role2"] == 1): ?>checked<?php endif; ?>>
                                            维修管理员<input type="checkbox" value="1" name="wxadmin" <?php if($vo["role3"] == 1): ?>checked<?php endif; ?>>
                                            钣金喷漆管理员<input type="checkbox" value="1" name="bjadmin" <?php if($vo["role4"] == 1): ?>checked<?php endif; ?>>

                                                <input type="submit"
                                                   class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" value="分配权限">
