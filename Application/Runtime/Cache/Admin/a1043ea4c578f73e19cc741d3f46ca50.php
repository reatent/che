                                        ...
                                        <td>
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <a href="/web/haval/index.php/Admin/Index/componentsadd?id=<?php echo ($vo["did"]); ?>"
                                                       class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">

                                                  <span class="am-icon-pencil-square-o"></span>增加零件

                                                    </a>
                                                    <a href="/web/haval/index.php/Admin/Index/displacementview?id=<?php echo ($vo["did"]); ?>"
                                                       class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">

                                                        <span class="am-icon-copy"></span>查看零件列表
