            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <!-- <span class="am-icon-code"></span> -->为<?php echo ($info["carname"]); ?>品牌增加车型
                    </div>
                </div>
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" method="post" action="/web/haval/index.php/Admin/Index/addcarmodel">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">车型名称</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="modelname" id="user-name" placeholder="车型名称">
                                        <input type="hidden" name="bid" value="<?php echo ($info["id"]); ?>">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <input type="submit" class="am-btn am-btn-primary" value="添加车型"/>
                                    </div>
                                </div>
                            </form>
                        </div>
