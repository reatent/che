                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-title">试驾车型</th>
                                    <th class="table-title">姓名</th>
                                    <th class="table-title">试驾时间</th>
                                    <th class="table-set">试驾类型</th>
                                ...
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><a href="#"><?php if($vo["shijia"] == 0): ?>到店体验<?php else: ?>上门体验<?php endif; ?></a></td>
                                        <td><a href="#"><?php if($vo["sex"] == 0): ?>女<?php else: ?>男<?php endif; ?></a></td>
