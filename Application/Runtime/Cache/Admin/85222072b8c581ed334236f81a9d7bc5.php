            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <!-- <span class="am-icon-code"></span> -->排量-年款修改
                    </div>
                </div>
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" method="post" action="/web/haval/index.php/Admin/Index/displacementsave">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">排量-年款</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="displacementname" id="user-name" value="<?php echo ($info["displacementname"]); ?>">
                                        <input type="hidden" name="did" value="<?php echo ($info["did"]); ?>">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <input type="submit" class="am-btn am-btn-primary" value="修改车型"/>
                                    </div>
                                </div>
                            </form>
                        </div>
