...
require(dirname(__FILE__).'/../Auth/Credential.php');
require(dirname(__FILE__).'/../Auth/ShaHmac1Signer.php');
require('IClientProfile.php');
#require(dirname(__FILE__).'/../Regions/ProductDomain.php');
#require(dirname(__FILE__).'/../Regions/Endpoint.php');
#require(dirname(__FILE__).'/../Regions/EndpointProvider.php');
