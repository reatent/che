...
require('Exception/ClientException.php');
require('Exception/ServerException.php');
#require('Regions/EndpointProvider.php');
require('Http/HttpHelper.php');
require('IAcsClient.php');
require('RpcAcsRequest.php');
